...
const GameCard = ({ icon, name, isOnSale = false, url }: GameCardProps) => {
  const iconUrl = icon 
    ? icon.startsWith('http') 
      ? icon 
      : `https://dev2-store.mmonster.co${icon}`
    : '/assets/home/games/default-icon.svg';
  ...
  return <div className={s.gameCard}>{content}</div>;
};
